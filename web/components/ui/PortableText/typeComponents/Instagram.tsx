...
const instagramIdRegex = /\/p\/(.*?)\//;

const matchInstragramId = (str: string): string[] | null => str.match(instagramIdRegex);

const getInstagramId = (url: string): string | null => {
  const maybeIdArray = matchInstragramId(url);
  return maybeIdArray && maybeIdArray[0];
};

// TODO: check this converted correctly
export const Instagram = ({ url }: { url: string }) => {
  if (!url) {
    console.error('Url not passed to PortableText/Instagram. Returning null.');
    return null;
  }
  ...
  if (!id) {
    console.error('Id could not be derived from Url in PortableText/Instagram. Returning null.');
    return null;
  }
  ...
  return (
    <div className='instagram-embed'>
      <blockquote
        ...
        className={`instagram-media ${styles.blockquoteWrapper}`}
        data-instgrm-permalink={url}
        data-instgrm-version='13'>
        <div className={styles.outerWrapper}>
          <a className={styles.linkWrapper} href={url} rel='noreferrer' target='_blank'>
            ...
            <div className={styles.div_8}>
              <div className={styles.div_9}>View this post on Instagram</div>
            </div>
